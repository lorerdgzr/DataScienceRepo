...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(
                                                            ...
                                                            options=[
                                                                ...
                                                                {'label': 'CCAF SLC-40', 'value': 'CCAF SLC-40'},
...
def update_scatter_chart(selected_site, selected_payload):            
                                        ...
                                        if  selected_site =='ALL':
                                            ...
                                            title='Relationship between Payload and Successful Missions for All Sites')
                                            return fig
                                        else:
                                            ...
                                            title=f'Relationship between Payload and Successful Missions for site {selected_site}')
                                            return fig
